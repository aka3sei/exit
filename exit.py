...
town_data = {
    '千代田区': ['一番町', '二番町', '三番町', '四番町', '五番町', '六番町', '紀白井町', '麹町', '富士見', '飯田橋', '九段北', '九段南', '隼町', '平河町', '永田町', '霞が関', '内幸町', '有楽町', '内神田', '外神田', '神田相生町', '神田淡路町', '神田和泉町', '神田岩本町', '神田小川町', '神田鍛冶町', '神田北乗物町', '神田紺屋町', '神田佐久間河岸', '神田佐久間町', '神田神保町', '神田須田町', '神田駿河台', '神田多町', '神田司町', '神田富山町', '神田錦町', '神田西福田町', '神田練塀町', '神田花岡町', '神田東紺屋町', '神田東松下町', '神田平河町', '神田松永町', '神田美倉町', '神田美土代町', '岩本町', '東神田', '西神田', '三崎町', '猿楽町', '丸の内', '大手町', '一ツ橋'],
        ...
        with c5_a:
            st.markdown(f"""
                <div class="prediction-card" style="border-top: 6px solid #8bc34a;">
                    <div class="pred-label">5年後 (インフレ年3%想定)</div>
                    <div class="pred-price" style="font-size: 1.8rem;">{round(p_5y_3pct):,} 万円</div>
        ...
        with c5_b:
            st.markdown(f"""
                <div class="prediction-card">
                    <div class="pred-label">5年後 (インフレ年5%想定)</div>
                    <div class="pred-price" style="font-size: 1.8rem;">{round(p_5y_5pct):,} 万円</div>
